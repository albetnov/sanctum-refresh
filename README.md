...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/sanctum-refresh.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/sanctum-refresh)
...
```bash
php artisan vendor:publish --tag="sanctum-refresh-views"
```

## Usage

```php
$sanctumRefresh = new Albet\SanctumRefresh();
echo $sanctumRefresh->echoPhrase('Hello, Albet!');
```
